    ...
    <div>
      ...
      <div className='p-5'>
        ...
        <div className='container mx-auto my-10'>
          ...
          <p className='text-lg my-5 text-justify'><b>Innovative Solutions</b> – We blend creativity with technology to deliver solutions that stand out.<br />
