    ...
    <div>
      ...
      <div>
        <div className='container mx-auto my-10 text-center '>
          ...
          <p className='text-lg text-justify m-5 lg:my-5'>At CodSpark, we offer a wide range of affordable and high-quality tech solutions to help businesses establish and grow their digital presence. Whether you need a website, mobile app, or e-commerce platform, we have the expertise to bring your vision to life.</p>
        </div>
      </div>

      <div>
        <div className='container mx-auto my-10 flex flex-col p-5 lg:grid grid-cols-2 flex items-center'>
          <img src="img1.gif" alt="" />
          <div>
            <h1 className='text-2xl font-bold'>Web Development – Build Your Online Presence</h1>
            <p className='text-lg my-5 text-justify'>In today’s digital world, a website is a must-have for any business. Whether you run a small startup or a large enterprise, having a professional website helps you:<br /><br />
      ...
      <div>
        <div className='container mx-auto my-10 flex flex-col p-5 lg:grid grid-cols-2 flex items-center'>
          <img className='lg:hidden' src="mobileDevelopment.gif" alt="" />
          <div>
          ...
          <img className='hidden lg:block' src="mobileDevelopment.gif" alt="" />
        </div>
      </div>
      ...
      <div>
        <div className='container mx-auto my-10 flex flex-col p-5 lg:grid grid-cols-2 flex items-center'>
          ...
          <div>
            ...
            <p className='text-lg my-5 text-justify'>Want to launch your online store and start selling your products or services? We build feature-rich and high-performance e-commerce websites that help you:<br /><br />
